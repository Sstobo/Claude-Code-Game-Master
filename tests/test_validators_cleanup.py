"""Phase 3 cleanup — validate_ability plus the four 5E vocab methods must be gone from lib.validators."""
...
def test_generic_validators_remain():
    ...
    for name in ("validate_name", "validate_attitude", "validate_dice",
                 "validate_quest_priority", "validate_time_of_day",
                 "validate_plot_type", "validate_plot_status"):
