...
class TimeManager:
    ...
    def update_time(self, time_of_day: str, date: str, elapsed_hours: float = 0.0, precise_time: str = None) -> bool:
        """
        ...
        # Calculate elapsed_hours from precise_time if NOT provided manually
        if elapsed_hours == 0.0 and precise_time:
